...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  ...
  Future<void> _resetPassword() async {
    ...
    if (username.isEmpty || otp.isEmpty || newPassword.isEmpty || newPasswordConfirm.isEmpty) {
      ScaffoldMessenger.of(
        context,
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              obscureText: true,
              decoration: const InputDecoration(labelText: 'Шинэ нууц үг давтах'),
            ),
            const SizedBox(height: 12),
            Row(
              children: [
                        ...
                        child: Center(
                          child: ElevatedButton.icon(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  _isPhoneValid ? const Color(0xFFFFE0B2) : Colors.grey[300],
                              foregroundColor:
                                  _isPhoneValid ? const Color(0xFF8C4A00) : Colors.grey[500],
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF00CCCC)),
                child:
                    _isLoading
