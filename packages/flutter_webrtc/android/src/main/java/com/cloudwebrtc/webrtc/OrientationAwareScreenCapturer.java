...
public class OrientationAwareScreenCapturer implements VideoCapturer, VideoSink {
    // VIRTUAL_DISPLAY_FLAG_AUTO_MIRROR is required for screen capture via MediaProjection.
    // FLAG_PRESENTATION creates a blank secondary display — on Android 14+ it no longer
    // receives screen content, producing grey frames.
